...
(location_id, name, address, phone_number, email, opening_hours)
VALUES
...
INSERT INTO members 
(member_id, first_name, last_name, email, phone_number, date_of_birth, join_date, emergency_contact_name, emergency_contact_phone)
VALUES
...
(equipment_id, name, type, purchase_date, last_maintenance_date, next_maintenance_date, location_id)
VALUES
...
INSERT INTO classes
(class_id, name, description, capacity, duration, location_id)
VALUES
...
(schedule_id, class_id, staff_id, start_time, end_time)
VALUES
...
(membership_id, member_id, type, start_date, end_date, status)
VALUES
...
(attendance_id, member_id, location_id, check_in_time, check_out_time)
VALUES
...
VALUES
(1, 1, 40.0, '2024-11-01 10:00:00', 'Credit Card', 'Monthly membership fee'),
(2, 2, 60.0, '2024-11-15 12:00:00', 'Bank Transfer', 'Monthly membership fee'),
(3, 3, 40.0, '2024-12-20 09:00:00', 'Credit Card', 'Monthly membership fee'),
(4, 5, 60.0, '2024-12-10 14:00:00', 'PayPal', 'Monthly membership fee'),
(5, 1, 40.0, '2025-01-01 10:00:00', 'Credit Card', 'Monthly membership fee'),
(6, 2, 60.0, '2025-01-15 12:00:00', 'Bank Transfer', 'Monthly membership fee'),
(7, 11, 20.0, '2025-01-20 15:30:00', 'Cash', 'Day pass');

INSERT INTO personal_training_sessions
(session_id, member_id, staff_id, session_date, start_time, end_time, notes)
VALUES
...
INSERT INTO member_health_metrics
(metric_id, member_id, measurement_date, weight, body_fat_percentage, muscle_mass, bmi)
VALUES
(1, 5, '2025-01-10', 65.0, 22.5, 48.0, 24.1),
(2, 3, '2025-01-15', 80.0, 18.0, 60.0, 25.5);

INSERT INTO equipment_maintenance_log
(log_id, equipment_id, maintenance_date, description, staff_id)
VALUES
